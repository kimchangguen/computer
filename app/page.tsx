...
export default async function Home() {
  ...
  return <SiteFrame><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: jsonLd(homeJsonLd) }}/><main><section className="hero"><div className="hero-grid shell">
